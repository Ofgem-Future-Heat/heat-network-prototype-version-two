...
router.post('/' + version + '/add-heat-network/introduction/communal', function (req, res) {
    ...
    if (req.session.data.validationError == "true") {
        ...
        if (introcommunal == "Yes") {
            ...
            res.redirect('/' + version + '/add-heat-network/introduction/connectedcommunal');
...
router.post('/' + version + '/add-heat-network/introduction/energycentre', function (req, res) {
    ...
    if (!introenergycentre) {
        ...
        req.session.data.validationErrors.introenergycentre = {
            ...
            "message": "Select whether the connected communal network has its own energy centre"
        }
    }
...
router.post('/' + version + '/add-heat-network/introduction/primary', function (req, res) {
    ...
    if (req.session.data.validationError == "true") {
        ...
        res.redirect('/' + version + '/add-heat-network/introduction/district');
...
router.post('/' + version + '/add-heat-network/introduction/howmany', function (req, res) {
    clearvalidation(req);
    var introcommunalnetworks = req.session.data['introcommunalnetworks']


    if (!introcommunalnetworks) {
        req.session.data.validationError = "true"
        req.session.data.validationErrors.introcommunalnetworks = {
            "anchor": "introcommunalnetworks",
            "message": "Enter the communal networks"
        }
    }
    ...
    if (req.session.data.validationError == "true") {
        res.render('/' + version + '/add-heat-network/introduction/howmany', {
            ...
            res.redirect(301, '/' + version + '/add-heat-network/introduction/control');
    }

});

// Introduction - introconnectedcommunal
router.get('/' + version + '/add-heat-network/introduction/connectedcommunal', function (req, res) {
    clearvalidation(req);
    res.render('/' + version + '/add-heat-network/introduction/connectedcommunal', {
        data: req.session.data
    });
});


router.post('/' + version + '/add-heat-network/introduction/connectedcommunal', function (req, res) {
    clearvalidation(req);
    var introconnectedcommunal = req.session.data['introconnectedcommunal']
    var introconnectedcommunalhowmany = parseInt(req.session.data['introconnectedcommunalhowmany'])
    var company = req.session.data['companyname'] || 'Radienteco Ltd';


    if (!introconnectedcommunal) {
        req.session.data.validationError = "true"
        req.session.data.validationErrors.introconnectedcommunal = {
            "anchor": "introconnectedcommunal",
            "message": "Select if " + company + " operate any connected communal networks?"
        }
    }
    if (introconnectedcommunal == "Yes" && !introconnectedcommunalhowmany)  {
        req.session.data.validationError = "true"
        req.session.data.validationErrors.introconnectedcommunalhowmany = {
            "anchor": "introconnectedcommunalhowmany",
    ...
    if (req.session.data.validationError == "true") {
        ...
        if (introconnectedcommunal == "No") {
            res.redirect('/' + version + '/add-heat-network/introduction/only');
        }
        else {
            req.session.data['introcommunalnetworks'] = req.session.data['introconnectedcommunalhowmany']
            res.redirect('/' + version + '/add-heat-network/introduction/control');
        }
