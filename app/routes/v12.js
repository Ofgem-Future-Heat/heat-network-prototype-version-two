...
/// ID Screener
router.get('/' + version + '/account-creation/one-login/id-screener', function (req, res) {
    clearvalidation(req);
    res.render('/' + version + '/account-creation/one-login/id-screener', {
        data: req.session.data
    });
});


router.post('/' + version + '/account-creation/one-login/id-screener', function (req, res) {
    clearvalidation(req);
    ...
    if (req.session.data.validationError == "true") {
        res.render('/' + version + '/account-creation/one-login/id-screener', {
            ...
            res.redirect('/' + version + '/account-creation/you-confirm');
    }
...
router.post('/' + version + '/account-creation/company-create', function (req, res) {
    ...
    if (req.session.data.validationError == "true") {
        ...
        if (companycreate == "No") {
            ...
            res.redirect('/' + version + '/account-creation/identity-halt');
        }
    }
...
///Service select
router.get('/' + version + '/account-creation/service-select', function (req, res) {
    clearvalidation(req);
    res.render('/' + version + '/account-creation/service-select', {
        data: req.session.data
    });
});


router.post('/' + version + '/account-creation/service-select', function (req, res) {
    clearvalidation(req);
...
///Reg contact
router.get('/' + version + '/account-creation/regulatory-contact', function (req, res) {
    clearvalidation(req);
    res.render('/' + version + '/account-creation/regulatory-contact', {
        data: req.session.data
    });
});


router.post('/' + version + '/account-creation/regulatory-contact', function (req, res) {
    clearvalidation(req);
    var regcontact = req.session.data['regcontact']
    var regcontactemail = req.session.data['regcontactemail']
    ...
    if (!regcontact) {
        ...
        req.session.data.validationErrors.regcontact = {
            "anchor": "regcontact",
            "message": "Select who should be the regulatory contact"
        }
    }
...
///You confirm
router.get('/' + version + '/account-creation/you-confirm', function (req, res) {
    clearvalidation(req);
    res.render('/' + version + '/account-creation/you-confirm', {
        data: req.session.data
    });
});
...
router.post('/' + version + '/account-creation/your-details', function (req, res) {
    ...
    var jobtitle = req.session.data['directorjobtitle']
    ...
    if (!jobtitle) {
        req.session.data.validationError = "true"
        req.session.data.validationErrors.directorjobtitle = {
            "anchor": "directorjobtitle",
